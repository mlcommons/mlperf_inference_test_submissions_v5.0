...
mlc pull repo anandhu-eng@mlperf-automations --checkout=ee852aa849722e2f94f97ac652b4fae49961b609
...
### Accuracy Results 
`acc`: `77.2`, Required accuracy for closed division `>= 0.72131`

### Performance Results 
`Samples per second`: `10.2876`
