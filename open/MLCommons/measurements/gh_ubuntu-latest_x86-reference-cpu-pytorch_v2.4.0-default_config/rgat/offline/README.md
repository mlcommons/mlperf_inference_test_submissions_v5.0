...
mlc pull repo GATEOverflow@mlperf-automations --checkout=63c5fab1b178ccf38ca5242a1ee88a234a0b360c
...
### Accuracy Results 
`acc`: `77.0`, Required accuracy for closed division `>= 0.72131`

### Performance Results 
`Samples per second`: `10.0629`
