...
mlc pull repo GATEOverflow@mlperf-automations --checkout=ec66d2137d9f2c5474e4936d4e08aedb385c01e8
...
### Accuracy Results 
`acc`: `74.0`, Required accuracy for closed division `>= 0.72131`

### Performance Results 
`Samples per second`: `10.1402`
