...
mlc pull repo GATEOverflow@mlperf-automations --checkout=96936edd52e8f9217e4ef79e9869f20ff391ba38
...
### Accuracy Results 
`acc`: `76.6`, Required accuracy for closed division `>= 0.72131`

### Performance Results 
`Samples per second`: `10.1306`
