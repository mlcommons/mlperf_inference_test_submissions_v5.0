...
mlc pull repo GATEOverflow@mlperf-automations --checkout=2ea81de0ae0b8a655442a43bd0997842862f508b
...
### Accuracy Results 
`acc`: `76.4`, Required accuracy for closed division `>= 0.72131`

### Performance Results 
`Samples per second`: `10.0455`
