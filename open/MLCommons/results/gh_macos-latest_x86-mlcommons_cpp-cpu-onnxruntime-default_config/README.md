    ...
    <div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
        ...
        <div class="table-container">
        <table class="table">
    <tr><td>framework</td><td>onnxruntime</td></tr><tr><td>operating_system</td><td> (darwin-23.6.0)</td></tr><tr><td>other_software_stack</td><td>Python: 3.12.8, LLVM-15.0.0</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
                </div>
            </div>
    ...
    <table class="table results-table">
        ...
        <th colspan="3">Offline</th>
            ...
            <td>Metric</td>
            <td>Performance</td>
            </tr><tr><td>resnet</td><td>acc: 75.6954</td><td>acc: 76.000</td><td>Samples/s</td> <td>9.78949</td><td></td><td></td><td></td><td></td><td></td><td></td></table></div>
