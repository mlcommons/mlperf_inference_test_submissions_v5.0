    ...
    <div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
        ...
        <div class="table-container">
        <table class="table">
    <tr><td>framework</td><td>pytorch v2.4.0</td></tr><tr><td>operating_system</td><td>Ubuntu 24.04 (linux-6.8.0-1020-azure-glibc2.39)</td></tr><tr><td>other_software_stack</td><td>Python: 3.12.8, GCC-13.3.0</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
                </div>
            </div>
    ...
    <table class="table results-table">
        ...
        <th colspan="3">Offline</th><td>Accuracy</td>
            ...
            <td>Metric</td>
            <td>Performance</td>
            </tr><tr><td>rgat</td><td>acc: 0.7213</td><td colspan="3"> N/A </td><td>acc: 75.600</td><td>Samples/s</td> <td>9.86571</td></table></div>
