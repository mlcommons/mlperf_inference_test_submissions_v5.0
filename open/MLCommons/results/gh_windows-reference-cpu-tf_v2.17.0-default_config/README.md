    ...
    <div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
        ...
        <div class="table-container">
        <table class="table">
    <tr><td>framework</td><td>tf v2.17.0</td></tr><tr><td>operating_system</td><td>Windows-2022Server-10.0.20348-SP0</td></tr><tr><td>other_software_stack</td><td>Python: 3.12.6, -</td></tr><tr><td>sw_notes</td><td>Automated by MLCommons CM v2.4.0. </td></tr></table></div></div>
                </div>
            </div>
    ...
    <table class="table results-table">
        ...
        <th colspan="3">Offline</th>
            ...
            <td>Metric</td>
            <td>Performance</td>
            </tr><tr><td>resnet</td><td>acc: 75.6954</td><td>acc: 76.000</td><td>Samples/s</td> <td>21.8155</td><td></td><td></td><td></td><td></td><td></td><td></td></table></div>
