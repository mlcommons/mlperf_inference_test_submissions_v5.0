    ...
    <div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
        ...
        <div class="table-container">
        <table class="table">
    <tr><td>framework</td><td>pytorch v2.4.1</td></tr><tr><td>operating_system</td><td>Ubuntu 22.04 (linux-6.2.0-39-generic-glibc2.35)</td></tr><tr><td>other_software_stack</td><td>Python: 3.10.12, LLVM-15.0.6</td></tr><tr><td>sw_notes</td><td>Automated by MLCommons CM v2.3.9. </td></tr></table></div></div>
                </div>
            </div>
    ...
    <table class="table results-table">
        ...
        <th colspan="3">Offline</th><td>Accuracy</td>
            ...
            <td>Metric</td>
            <td>Performance</td>
            </tr><tr><td>stable-diffusion-xl</td><td>CLIP_SCORE: 31.6863</td><td>CLIP_SCORE: 31.6863, FID_SCORE: 23.0109</td><td></td><td></td><td></td><td>CLIP_SCORE: 15.18544016778469  FID_SCORE: 235.69504308101006</td><td>Samples/s</td> <td>0.374837</td></table></div>
