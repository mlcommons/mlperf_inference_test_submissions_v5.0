    ...
    <div class="yellow-strip floater" data-speed="0.1" style="transform: translate3d(0px, 19px, 0px);">
        ...
        <div class="table-container">
        <table class="table">
    <tr><td>framework</td><td>deepsparse v1.8.0</td></tr><tr><td>operating_system</td><td>Ubuntu 24.04 (linux-6.8.0-1020-azure-glibc2.39)</td></tr><tr><td>other_software_stack</td><td>Python: 3.11.11, LLVM-18.1.3</td></tr><tr><td>sw_notes</td><td></td></tr></table></div></div>
                </div>
            </div>
    ...
    <table class="table results-table">
        ...
        <th colspan="3">Offline</th>
            ...
            <td>Metric</td>
            <td>Performance</td>
            </tr><tr><td>bert-99</td><td>F1: 89.9653</td><td>F1: 80.0</td><td>Samples/s</td> <td>6.26939</td><td></td><td></td><td></td><td colspan="3"> N/A </td></table></div>
